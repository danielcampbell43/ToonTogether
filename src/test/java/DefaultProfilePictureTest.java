...
public class DefaultProfilePictureTest {
    WebDriver driver;
    Faker faker;
    ...
    public void usersMostRecentPlaylistAppearsOnProfilePage() {
        ...
        WebElement defaultProfilePicture = driver.findElement(By.id("profile-picture"));
        Assert.assertTrue(defaultProfilePicture.isDisplayed());
    }
}
